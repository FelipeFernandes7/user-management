...
export function List({ payed, name, presence, givenUp }: ListProps) {
  return (
    <main className="w-full flex relative items-center flex-col bg-[#151515] p-4 shadow-md rounded-md cursor pointer hover:scale-105 transition-all duration-300 ease-linear">
